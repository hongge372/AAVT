...
public class EglHelper {
    ...
    public static EGLContext shareContex = null;
    ...
    public boolean createGLESWithSurface(EGLConfigAttrs attrs, EGLContextAttrs ctxAttrs, Object surface) {
        ...
        if(shareContex!=null){
            Log.v(TAG, "share opengl stu, shareContex create !!!!!!");
            mEGLContext = createContext(config, shareContex, ctxAttrs.makeDefault(true));
        }else {
            Log.v(TAG, "share opengl stu, default create !!!!!!");
